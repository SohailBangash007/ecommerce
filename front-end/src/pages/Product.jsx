    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row ">
        ...
        <div className="flex-1">
          ...
          <button onClick={()=>addToCart(productData._id,size)} className="bg-black text-white px-8 py-3 rounded-3xl text-sm active:bg-gray-700">
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col border text-sm gap-4 px-6 py-6 text-gray-500">
          <p>
